...
Route::group(['prefix' => 'productos', 'middleware' => 'auth'], function () {
    ...
    Route::get(
        '/info-mecanica/{mechanicals}/editar',
        [
    ...
    Route::get(
        '/caracteristicas/{mechanicals}/editar',
        [
    ...
    Route::get(
        '/valores-nutricionales/{mechanicals}/editar',
        [
    ...
    Route::patch(
        '/valores-nutricionales/{mechanicals}',
        [
